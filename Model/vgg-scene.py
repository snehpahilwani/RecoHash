# -*- coding: utf-8 -*-
"""
Created on Thu Nov 23 01:24:28 2017
...
def VGG16_Places365(include_top=True, weights='places',
    ...
    # Create model
    model = Model(data, prob, name='vgg_places_365')
...
im = cv2.resize(cv2.imread('D:\RecoHash\Model\download.jpg'), (224, 224)).astype(np.float32)  
im = np.reshape(im, (1,224,224,3))  
model = VGG16_Places365(include_top=True, weights='places')#, pooling='max')
